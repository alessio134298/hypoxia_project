...
filesBigWigAverage <- c("H3K27ac/bamCoverage/CAS9_normoxia_H3K27ac.bw",
                        ...
                        "H3K4me1/bamCoverage/CAS9_normoxia_H3K4me1.bw",
                         "H3K4me1/bamCoverage/H4KO_normoxia_H3K4me1.bw")
...
colors <- c('#ba226e', '#ba226e', '#059e54', '#059e54', '#104ade', '#104ade')
for (i in seq_along(filesBigWigAverage)) {
  ...
  DATATRACK = DataTrack(BW,
                        ...
                        ylim = c(0,40)) #settato a 30 per le tracks di intersection , a 70 per i SEs
...
```{r}
plot.and.save.track.Bw.avg <- function(Sample, locus, from, to, chr, realstart, realend) {
  ...
  png(paste0("/media/alessio/Data/hypoxia/ChIPseq/Figure_paper/Tracks_SEs_HDAC4/",Sample,"_",locus,".png"), height = 15, width = 30, units = 'cm', res = 300)
  
  track <- plotTracks(c(BigWigAverage.Normoxia.Datatracks,
                        HDAC4_bigwig,
                        Highlight_peak
  ),
  sizes = c(1,1,1,1,1,1,1,0.3),
  from = from,
  to = to,
  chromosome = chr,
  transcriptAnnotation = "gene",
...
# chr5:93395427-93656793
# chr5:93564555-93609265
plot.and.save.track.Bw.avg("SEs.UP.HDAC4peaks", 'chr5:93564555-93609265' , 92406196, 93812306, 'chr5', 93564555, 93609265)

# chr5:58782931-59311742
# chr5:58860683-59198224
plot.and.save.track.Bw.avg("SEs.UP.HDAC4peaks", 'chr5:58782931-59198224' , 58553985, 59311742, 'chr5', 58860683, 59198224)

# chr9:13204438-14823161
# chr9:14302360-14434739 
plot.and.save.track.Bw.avg("SEs.UP.HDAC4peaks", 'chr9:14302360-14434739' , 13204438, 14823161, 'chr9', 14302360, 14434739)

# poised to active with HDAC4
# chr6:90,014,009-90,324,261
# chr6:90215207-90221809
plot.and.save.track.Bw.avg("poised_to_active.HDAC4peaks", 'chr6:90215207-90221809' , 90014009, 90324261, 'chr6', 90215207, 90221809)

# chr1:78,506,227-78,713,434
# chr1:78616129-78627923
plot.and.save.track.Bw.avg("poised_to_active.HDAC4peaks", 'chr1:78616129-78627923' , 78506227, 78713434, 'chr1', 78616129, 78627923)

# active to poised
# chr5:88,630,416-88,800,152
# chr5:88674075-88674997
plot.and.save.track.Bw.avg("active_to_poised.HDAC4peaks", 'chr5:88674075-88674997', 88630416, 88800152, 'chr5', 88674075, 88674997)


# chr7:96,854,787-97,273,937
# chr7:97023308-97025679
plot.and.save.track.Bw.avg("active_to_poised.HDAC4peaks", 'chr7:97023308-97025679', 96854787, 97273937, 'chr7', 97023308, 97025679)
