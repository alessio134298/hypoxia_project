...
calculate_cutoff <- function(inputVector, drawPlot=TRUE,...){
	...
	#Metti cutoff ad un numero fisso 1414.566
	#return(list(absolute=1414.566,overMedian=y_cutoff/median(inputVector),overMean=y_cutoff/mean(inputVector)))
}
...
print("Those are the cutoff parameters used")
print(cutoff_options$absolute)
