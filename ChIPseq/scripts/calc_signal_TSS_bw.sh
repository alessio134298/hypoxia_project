...
# do also for the bamcoverage
cp /media/alessio/Data/genome110/gencode/Gencode_V44_TSS_withheader.bed /media/alessio/Data/hypoxia/ChIPseq/TSS_bw_signal_bcoverage.bed

for sample in C1A C2A K125A1 K26A1
    do
    python /media/alessio/Data/hypoxia/ChIPseq/scripts/Calculate_Bw_signal_on_bed.py \
    ${path}/${sample}/${sample}.bamCoverageRPKM.bw \
    /media/alessio/Data/hypoxia/ChIPseq/TSS_bw_signal_bcoverage.bed \
    ${sample}.bamCoverageRPKM.bw
