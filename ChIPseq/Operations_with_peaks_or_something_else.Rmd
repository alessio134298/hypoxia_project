...
intersected.peaks.normoxia <- list(
  ...
  Cas9.CommonPeaks.H3K27ac.on.H2BK120ac = subsetByOverlaps(Peaks.IDR.H3K27ac$Cas9_normoxia, Peaks.IDR.H2BK120ac$Cas9_normoxia),
  Cas9.CommonPeaks.H2BK120ac.on.H3K27ac = subsetByOverlaps(Peaks.IDR.H2BK120ac$Cas9_normoxia, Peaks.IDR.H3K27ac$Cas9_normoxia),
  ...
  H4KO.CommonPeaks.H3K27ac.on.H2BK120ac = subsetByOverlaps(Peaks.IDR.H3K27ac$H4KO_normoxia, Peaks.IDR.H2BK120ac$H4KO_normoxia),
  H4KO.CommonPeaks.H2BK120ac.on.H3K27ac = subsetByOverlaps(Peaks.IDR.H2BK120ac$H4KO_normoxia, Peaks.IDR.H3K27ac$H4KO_normoxia),
...
Intersections.PLot <- Intersections.PLot.H3K27ac  | Intersections.PLot.H2BK120ac
Intersections.PLot
```

#savlo il plot
```{r}
ggsave(Intersections.PLot, file = "plot/Annobar_intersected_peaks_exclusive_normoxia.png", height = 8, width = 9, dpi = 300)
```
