...
```{r}
Table_Signal_Bw_TSS <- read_delim("../ChIPseq/TSS_bw_signal.bed") %>% 
...
png("Heatmap_Promoter.png", width = 22, height = 24, units = "cm", res = 600, bg = "transparent")
draw(Hmap_promoter, background = NA)
dev.off()
